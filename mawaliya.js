...
function displayFeedback(boxid){
	...
	switch(boxid){
	case 1:{
	feedbackData="<strong> Investments  </strong> "+
		"<p>As far as Mutual Funds are concerned, SEBI formulates policies and regulates the Mutual Funds to protect the interest of the investors. Some of the policies included are:</p>"+
		"<ul> "+
			"<li> "+
	...
	case 2:{
	feedbackData="<strong> Investments: Real Estate </strong>"+	
		"<ul><li>Real Estate Mutual Funds (REMFs) are permitted in India"+
	...
	case 3:{
	feedbackData="<strong> Investments: International Funds </strong>"+	
	
		"<ul><li>International Funds, floated in India, can invest abroad in:<ul><li>ADRs/GDRs issued by Indian or foreign companies*</li><li>Equity of overseas companies*&nbsp;</li><li>Initial and follow on public offerings*&nbsp;</li> "+
...
"<li>Resident individuals use rupees to invest in Indian Mutual Funds, even when these schemes invest abroad. &nbsp;Such investments in rupees are not restricted by this limit&nbsp;</li></ul></li></ul></li></ul>";
	...
	case 4:{
	feedbackData="<strong> Investments: Short Term Deposits </strong>"+	
	...
	case 5:{
	feedbackData="<strong> Investment: Derivatives   </strong>"+		
	"<ul><li>Mutual Funds can invest in derivative instruments after notifying investors<ul><li>Mutual Funds cannot write options or buy instruments with embedded written options</li><li>Total exposure related to option premium paid must not exceed 20% of the net assets of the scheme</li> "+
	...
	case 6:{
	feedbackData="<strong> Investment: Repos in Corporate Debt Securities </strong>"+		
		"<ul><li>Mutual Funds are permitted to participate in Repos in Corporate Debt Securities, subject to the following:<ul> "+
...
function showFinal(boxid){
	...
	switch(boxid){
	case 1:{
	feedbackData="<strong> Infrastructure Debt Funds </strong>"+		
	...
	case 2:{
	feedbackData="<strong> FMPs     </strong>"+	
		"<ul><li>Investors cannot prematurely offer the units for re-purchase&nbsp;</li>"+
	...
	case 3:{
	feedbackData="<strong> Interval Schemes </strong>"+	
		"<ul><li>Interval schemes must be mandatorily listed</li><li>Redemption/ Repurchase of units will be allowed only during the specified transaction period (when units can be purchased and redeemed)</li>"+
	...
	case 4:{
	feedbackData="<strong>Minimum Number of Investors  </strong>"+	
		"<ul><li>To avoid concentration of investors in a scheme, SEBI mandates that :<ul><li>Every Mutual Fund scheme should have at least 20 investors</li><li>No single investor should hold more than 25% of the corpus</li> "+
	...
	case 5:{
	feedbackData="<strong> Additional Plans </strong>"+	
	...
	document.getElementById("feedback3").innerHTML = feedbackData;
}